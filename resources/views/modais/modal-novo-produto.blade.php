<div class="modal fade" tabindex="-1" id="dlgNovoProduto">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('produto.save') }}" method="post" autocomplete="off">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="preco_custo" id="" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="" class="form-label">Preço de Venda:</label>
                                <input type="text" name="preco_venda" id="" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
